...
tsx = float(input('Enter the X Coordinate of Target Ship : '))
tsy = float(input('Enter the Y Coordinate of Target Ship : '))
tsv = float(input('Enter the Speed of Target Ship (Knots): '))
tsa = float(input('Enter the angle of Target Ship (Deg)  : '))
tsl = float(input('Enter the length of Target Ship (Mtr) : '))

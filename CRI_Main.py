...
osa = 40#float(input('Enter the angle of Own Ship (Deg)  : '))
osl = 100#float(input('Enter the length of Own Ship (Mtr) : '))

print('\nEnter the details for Target Ship\n')
print('---------------------------------------------')

tsx = 10#float(input('Enter the X Coordinate of Target Ship : '))
tsy = 7#float(input('Enter the Y Coordinate of Target Ship : '))
tsv = 12#float(input('Enter the Speed of Target Ship (Knots): '))
tsa = 320#float(input('Enter the angle of Target Ship (Deg)  : '))
